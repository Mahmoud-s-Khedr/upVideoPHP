...
B2_REGION=$B2_REGION
B2_UPLOAD_PRESIGN_TTL_SECONDS=$B2_UPLOAD_PRESIGN_TTL_SECONDS
...
PENDING_UPLOAD_TTL_MINUTES=$PENDING_UPLOAD_TTL_MINUTES
MIN_DISK_FREE_BYTES=$MIN_DISK_FREE_BYTES
FFMPEG_MAX_MINUTES=$FFMPEG_MAX_MINUTES
EOF
...
B2_UPLOAD_PRESIGN_TTL_SECONDS="${B2_UPLOAD_PRESIGN_TTL_SECONDS:-14400}"
MULTIPART_PART_SIZE_BYTES="${MULTIPART_PART_SIZE_BYTES:-67108864}"
WORKER_POLL_INTERVAL="${WORKER_POLL_INTERVAL:-5}"
STALE_JOB_TIMEOUT_MINUTES="${STALE_JOB_TIMEOUT_MINUTES:-120}"
PENDING_UPLOAD_TTL_MINUTES="${PENDING_UPLOAD_TTL_MINUTES:-60}"
MIN_DISK_FREE_BYTES="${MIN_DISK_FREE_BYTES:-21474836480}"
FFMPEG_MAX_MINUTES="${FFMPEG_MAX_MINUTES:-360}"
